...
class Goal(Event):
	def __init__(self,name=""):
		...
		self.urls = {
			...
			"The secret to life the universe and everything" : "https://miro.medium.com/max/630/0*RXlZHWuivkapvRYe",
			"Planet Ohio" : "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSjsEYb9SwkLJXaBSkdF9FJJL8tRKjJYNv5Kw&usqp=CAU",
			"The edge of the universe" : "https://miro.medium.com/max/1200/0*YZ-yUPSfpPA0juqm.jpg",
	...
	def __init__(self,name=""):
		...
		self.properties = {
			...
			"Unicron":{
				...
				"url"  : "https://tfwiki.net/mediawiki/images2/thumb/3/37/IDW_Unicron_Alex_Milne.jpg/360px-IDW_Unicron_Alex_Milne.jpg"
				},
			"Zebes":{
			...
			"Uranus":{
				...
				"url"  : "https://www.sciencealert.com/images/2019-06/processed/uranus-voyager-photo_1024.jpg"
				},
			"Galvan Prime":{
			...
			"Capitan del espacio":{
				...
				"url"  : "https://lh3.googleusercontent.com/proxy/_WrVdAy_VEJzw2X_2dzlgJdynevWSGCvnX1Y0E-DYwim8o7SeCXSLahPVUeb2_9VZgUlablMQqxajBC_zBn4JGob4aTTlVY6FH_oHoP9ShuQ16Dyrchxwa_unLM"
				},
			"Pluto":{
...
class Ship(Event):
	def __init__(self,name=""):
		...
		self.properties = {
			...
			"Capitan Beto":{
				"good" : "His ring makes you inmune to danger. You get 20 fuel",
...
class Asteroid(Event):
	def __init__(self,name=""):
		...
		self.urls = {
			...
			"Higuain's penalty" : "https://lh3.googleusercontent.com/proxy/CjOZH2-Bj9aHAMaPmd6Kon0ficBdtAX3xuFxJA4iBOLkB1IK0-PyfYBbBSWQsncIikF9YPx1W7-nAQMZt5fQNPuVLL2r8MldHd-q4o7tJbfZUNZH06K0EqrtEZzRzmiwEqaIbWuBhRUHqGWqzFQSNd_zPiUkRHAelTfQiID8NJZgVyVedTDmP2FjJLp4IUpNAwzlcwaAEbUupPFgFef10M1omn8pkU2lS6xR_UXmuag",
